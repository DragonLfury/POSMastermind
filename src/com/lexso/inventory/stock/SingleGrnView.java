...
public class SingleGrnView extends javax.swing.JDialog {

    private String id;

    public SingleGrnView(java.awt.Frame parent, boolean modal, String id) {
        super(parent, modal);
        initComponents();
        this.id = id;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SingleGrnView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SingleGrnView dialog = new SingleGrnView(new javax.swing.JFrame(), true, "");
