 ...
 * @author User
 */
public class MonthlySales_Report extends javax.swing.JDialog {

    /**
     * Creates new form MonthlySales_Report
     */
    public MonthlySales_Report(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadInvoices();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MonthlySales_Report dialog = new MonthlySales_Report(new javax.swing.JFrame(), true);
