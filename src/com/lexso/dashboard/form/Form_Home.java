...
import com.lexso.dashboard.dialog.Message;
...
import com.lexso.dashboard.swing.noticeboard.ModelNoticeBoard;
...
public class Form_Home extends javax.swing.JPanel {
    ...
    private void initTableData() {
        ...
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/com/lexso/dashboard/icon/profile.jpg")), "Abdullah Ghouse", "Male", "Java", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/com/lexso/dashboard/icon/profile1.jpg")), "Anton Shane", "Male", "C++", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/com/lexso/dashboard/icon/profile2.jpg")), "Dinushika Prasangani", "Female", "C#", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/com/lexso/dashboard/icon/profile2.jpg")), "Harindu Perera", "Male", "C#", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/com/lexso/dashboard/icon/profile2.jpg")), "Heshan Tharusha", "Male", "C#", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/com/lexso/dashboard/icon/profile2.jpg")), "Hirusha Dayarathna", "Male", "C#", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/com/lexso/dashboard/icon/profile2.jpg")), "Lochana Nissanka", "Male", "C#", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/com/lexso/dashboard/icon/profile2.jpg")), "Sithika Samadith", "Male", "C#", 300).toRowTable(eventAction));
    }
    ...
    private void initCardData() {
        ...
        card1.setData(new ModelCard("Total Sales", 5100, icon1));
        ...
        card2.setData(new ModelCard("Total Customers", 2000, icon2));
        Icon icon3 = IconFontSwing.buildIcon(GoogleMaterialDesignIcons.SHOPPING_BASKET, 60, new Color(255, 255, 255, 100), new Color(255, 255, 255, 15));
        card3.setData(new ModelCard("Total Items", 3000, icon3));
        Icon icon4 = IconFontSwing.buildIcon(GoogleMaterialDesignIcons.BUSINESS_CENTER, 60, new Color(255, 255, 255, 100), new Color(255, 255, 255, 15));
        card4.setData(new ModelCard("Total Item Kits", 550, icon4));
    }
    ...
    private void initComponents() {
        ...
        card1 = new com.lexso.dashboard.component.Card();
        jLabel1 = new javax.swing.JLabel();
        card2 = new com.lexso.dashboard.component.Card();
        card3 = new com.lexso.dashboard.component.Card();
        card4 = new com.lexso.dashboard.component.Card();
        jPanel1 = new javax.swing.JPanel();
        noticeBoard = new com.lexso.dashboard.swing.noticeboard.NoticeBoard();
        ...
        table1 = new com.lexso.dashboard.swing.table.Table();

        card1.setBackground(new java.awt.Color(0, 0, 204));
        card1.setColorGradient(new java.awt.Color(153, 153, 255));

        jLabel1.setFont(new java.awt.Font("sansserif", 1, 12)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(4, 72, 210));
        jLabel1.setText("Dashboard / Home");

        card2.setBackground(new java.awt.Color(0, 153, 0));
        card2.setColorGradient(new java.awt.Color(204, 255, 102));

        card3.setBackground(new java.awt.Color(153, 0, 51));
        card3.setColorGradient(new java.awt.Color(255, 212, 99));

        card4.setBackground(new java.awt.Color(204, 102, 0));
        card4.setColorGradient(new java.awt.Color(255, 204, 153));
    ...
    private com.lexso.dashboard.component.Card card1;
    private com.lexso.dashboard.component.Card card2;
    private com.lexso.dashboard.component.Card card3;
    private com.lexso.dashboard.component.Card card4;
    ...
    private com.lexso.dashboard.swing.noticeboard.NoticeBoard noticeBoard;
    private com.lexso.dashboard.swing.table.Table table1;
