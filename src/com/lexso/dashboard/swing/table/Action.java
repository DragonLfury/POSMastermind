...
public class Action extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdEdit = new com.lexso.dashboard.swing.Button();
        cmdDelete = new com.lexso.dashboard.swing.Button();

        cmdEdit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/lexso/dashboard/icon/edit.png"))); // NOI18N

        cmdDelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/lexso/dashboard/icon/delete.png"))); // NOI18N
    ...
    private com.lexso.dashboard.swing.Button cmdDelete;
    private com.lexso.dashboard.swing.Button cmdEdit;
